...
#include "monitorFunctionFromTanhAntiSym.H"
#include "fvcCurlf.H"
...
defineTypeNameAndDebug(monitorFunctionFromTanhAntiSym, 0);
addToRunTimeSelectionTable(monitorFunctionFrom, monitorFunctionFromTanhAntiSym, dictionary);


// * * * * * * * * * Protected Member Functions * * * * * * * * * * * * * //

Foam::tmp<Foam::volScalarField> Foam::monitorFunctionFromTanhAntiSym::monitorBase
(
...
Foam::tmp<Foam::volScalarField> Foam::monitorFunctionFromTanhAntiSym::baseToMonitor
(
...
Foam::monitorFunctionFromTanhAntiSym::monitorFunctionFromTanhAntiSym
(
